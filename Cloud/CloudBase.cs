...
{
    public class CloudBaseSettings
    {
        public readonly static string ApiServerUrl = "https://mongorest.azurewebsites.net/api/MongoDB/";
        public readonly static string GetEndPoint = "GetFilteredData";
        public readonly static string GetAllEndPoint = "GetAllDataByCollectionName";
        public readonly static string GetManyEndPoint = "GetMultipleCollectionsByName";
        public readonly static string CreateEndPoint = "CreateCollection";
        public readonly static string DeleteEndPoint = "DeleteCollection";
        public readonly static string UpdateEndPoint = "UpdateCollection";

        public static string GetURL { get => $"{ApiServerUrl}{GetEndPoint}"; }
        public static string GetAllURL { get => $"{ApiServerUrl}{GetAllEndPoint}"; }
        public static string GetManyURL { get =>  $"{ApiServerUrl}{GetManyEndPoint}"; }
        public static string CreateURL { get => $"{ApiServerUrl}{CreateEndPoint}"; }
        public static string DeleteURL { get => $"{ApiServerUrl}{DeleteEndPoint}"; }
        public static string UpdateURL { get => $"{ApiServerUrl}{UpdateEndPoint}"; }
    ...
    public class CloudBase<T> where T : new()
    {
        /// <summary>
